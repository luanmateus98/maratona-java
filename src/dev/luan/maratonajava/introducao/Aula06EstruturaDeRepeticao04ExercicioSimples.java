...
public class Aula06EstruturaDeRepeticao04ExercicioSimples {
    ...
    public static void main(String[] args) {
        ...
        for (int parc = 1; parc < valCar; parc++) {
            ...
            if (valParc < 1000){ // Só mudou a lógica e já deu uma simplificada
                break; // Para a execução do programa e pula para fora do for.
            }
